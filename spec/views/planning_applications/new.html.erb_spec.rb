...
describe "planning_applications/new" do
  before(:each) do
    assign(:planning_application, stub_model(PlanningApplication,
      :user_id => 1,
  ...
  it "renders new planning_application form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => planning_applications_path, :method => "post" do
